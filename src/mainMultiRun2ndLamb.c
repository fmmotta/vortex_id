...
int main(int argc,char **argv){
  ...
  dadosgen=fopen("data/Uniform Comparison/2ndSwirl/multiRunGen.txt","w");
  err=fprintfRunParameters(dadosgen,seed,x0,xf,dx,Gmin,Gmax,rmin,
                           rmax,xmin,xmax,v0y0);
  fclose(dadosgen);

  dadosVin = fopen("data/Uniform Comparison/2ndSwirl/inputVortexes.txt","w");
  dadosVout = fopen("data/Uniform Comparison/2ndSwirl/outputVortexes.txt","w");
  ...
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoOuG.txt","w");
  gsl_histogram_fprintf(dadosout,hG,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoOuRc.txt","w");
  gsl_histogram_fprintf(dadosout,hRc,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoOua.txt","w");
  gsl_histogram_fprintf(dadosout,ha,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoOub.txt","w");
  gsl_histogram_fprintf(dadosout,hb,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoOuN.txt","w");
  gsl_histogram_fprintf(dadosout,hN,"%f","%f");
  fclose(dadosout);

  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoInG.txt","w");
  gsl_histogram_fprintf(dadosout,iG,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoInRc.txt","w");
  gsl_histogram_fprintf(dadosout,iRc,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoIna.txt","w");
  gsl_histogram_fprintf(dadosout,ia,"%f","%f");
  fclose(dadosout);
  dadosout=fopen("data/Uniform Comparison/2ndSwirl/histoInb.txt","w");
