...
int floodFill(double *sField,int Width,int Height,int NumCls,int **eqClass,int *eqPop,int *label);

int renameLabels(int Height,int Width,int NumCls,int *labelTag,int *label);
